...
export const zConfigSectionResponse = z.object({
  ...
  links: z.object({
    self: z.string().default('/api/v2/ui/configsections/1')
  }),
  data: z.object({
    id: z.int(),
...
export const zConfigSectionListResponse = z.object({
  ...
  links: z.object({
    ...
    first: z.string().default('/api/v2/ui/configsections?page[size]=25'),
    last: z
      .string()
      .nullable()
      .default(
        '/api/v2/ui/configsections?page[size]=25&page[before]=eyJwcmltYXJ5Ijp7InNvbWVVbnFpdWVGaWVsZCI6MTIzfSwic2Vjb25kYXJ5Ijp7InNvbWVPdGhlck9wdGlvbmFsRmllbGQiOiJGb28ifX0='
      ),
    next: z
      .string()
      .nullable()
      .default(
        '/api/v2/ui/configsections?page[size]=25&page[after]=eyJwcmltYXJ5Ijp7InNvbWVVbnFpdWVGaWVsZCI6MTIzfSwic2Vjb25kYXJ5Ijp7InNvbWVPdGhlck9wdGlvbmFsRmllbGQiOiJGb28ifX0='
      ),
    prev: z
      .string()
      .nullable()
...
export const zConfigSectionCountResponse = z.object({
  jsonapi: z.object({
    version: z.string().default('1.1'),
    ext: z.array(z.string()).optional().default(['https://jsonapi.org/profiles/ethanresnick/cursor-pagination'])
  }),
