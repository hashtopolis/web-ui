  ...
  describe("Main form tests", () => {
    ...
    it("enables form submission when form is valid", () => {
      ...
      const btn = fixture.debugElement.query(
        By.css('[data-testid="button-update-submit"]')
      );
    ...
    it("submits form with valid email", () => {
      ...
      const btnDebugEl = fixture.debugElement.query(
        By.css('[data-testid="button-update-submit"]')
      );
  ...
  describe("Password change form tests", () => {
    ...
    it("validates password length", () => {
      const newPasswordControl =
        component.changepasswordFormGroup.get("newPassword");
      const confirmPasswordControl =
        component.changepasswordFormGroup.get("confirmNewPassword");
      ...
      newPasswordControl.patchValue(
        "VeryNiceLongPasswordButTooLongForHashtopolis"
      );
    ...
    it("validates password match", () => {
      ...
      fixture.detectChanges();
      expect(
        component.changepasswordFormGroup.hasError("passwordMismatch")
      ).toBe(true);
    ...
    it("Submits password form and resets on success", fakeAsync(() => {
      ...
      const btn = fixture.debugElement.query(
        By.css('[data-testid="button-password-submit"]')
      );
      ...
      // Assert
      expect(chelperSpy).toHaveBeenCalledOnceWith(
        SERV.HELPER,
        "changeOwnPassword",
        {
          oldPassword: "oldPass123",
      ...
      expect(component["alert"].showSuccessMessage).toHaveBeenCalledOnceWith(
