...
export class NotificationsContextMenuService extends ContextMenuService {
  ...
  addContextMenu(): NotificationsContextMenuService {
    ...
    this.addCtxEditItem(RowActionMenuLabel.EDIT_NOTIFICATION, RowActionMenuAction.EDIT, permUpdate);
    ...
    this.addCtxDownloadItem(RowActionMenuLabel.DEACTIVATE_NOTIFICATION, permDelete);
