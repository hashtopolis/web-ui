...
/**
 * Components-only sibling of HomeModule. Same declarations, same dependencies,
 * but without HomeRoutingModule — so other feature modules can render
 * `<app-home>` without inheriting the home `path: ''` route.
 */
@NgModule({
