...
/**
 * Components-only sibling of TasksModule. Same declarations, same dependencies,
 * but without TasksRoutingModule — so other feature modules can render
 * `<app-show-tasks>` / `<app-new-tasks>` without inheriting the tasks
 * route table.
 */
@NgModule({
  declarations: [
